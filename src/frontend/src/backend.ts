...
import type { SendEmailResult as _SendEmailResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async sendEmail(arg0: string, arg1: string, arg2: string): Promise<SendEmailResult> {
        if (this.processError) {
            try {
                const result = await this.actor.sendEmail(arg0, arg1, arg2);
                return from_candid_SendEmailResult_n1(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
...
function from_candid_SendEmailResult_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SendEmailResult): SendEmailResult {
